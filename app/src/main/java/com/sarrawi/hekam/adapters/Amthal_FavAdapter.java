...
public class Amthal_FavAdapter extends RecyclerView.Adapter<Amthal_FavAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tv_Name;
        ImageView img_fav,share,copy,shared;
    ...
    public Amthal_FavAdapter(List<Amthal> amthal_list, Context context, Typeface fontFamily, int fontSize)
    {
        this.con = context;
    ...
    @NonNull
    @Override
    public Amthal_FavAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Amthal_FavAdapter.MyViewHolder holder, final int position) {
